...
<Accordion title="New Accordion" description="Some Description" icon="sparkles">
  this is eh accordion.

  ## heading 2
</Accordion>

<AccordionGroup>
  <Accordion title="Accordion title" description="Accordion Description" defaultOpen icon="sparkles">
    Some contentwill be here.
...
<iframe src="https://google.com" title="description" />
...
<Update label="07/31/2025" description>
